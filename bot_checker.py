...
URLS = {
    ...
    "Month after next month": "https://vhs-tempelhof-schoeneberg.appointmind.net/?&separate_appointment_reason_first=1&select_month=2"
}
...
def check_slots():
    ...
    for name, url in URLS.items():
        ...
        if "Keine freien Termine" not in soup.text:
